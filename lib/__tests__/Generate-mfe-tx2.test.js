...
describe('Generate tx2 types', () => {
    ...
    it('MF-e', () => {
        ...
        const tx2 = (0, index_1.generateMFeTx2)(`${dirPath}/${tx2FileName}`, invoiceInformation, [invoiceItems], [invoicePayment], invoiceTechnical);
        expect(tx2).toBe(tx2);
    });
    it('send payment', () => {
        const dirPath = path.resolve(__dirname, 'static', 'files', 'tx2', 'communication');
        index_test_1.default.createFilePath(dirPath);
        (0, index_1.sendPaymentMfeTx2)(`${dirPath}/test-send-payment.txt`, {
            docNumber: '11155',
            company: {
                cnpj: '08723218000186',
...
tributos deste cupom(conforme
  ...
  <urlqrcode>35180508723218000186599000145370000637310995|20180517114225|10.00||</urlqrcode>]]>`,
        ...
        (0, index_1.invoceResponseMfeTx2)(`${dirPath}/test.txt`, posDataInformation);
        expect(1).toBe(1);
    });
});
