...
const createObservacoes = (caminhoTx2, obs) => {
    return new Promise((resolve) => {
 ...
 */
const generateNFCeTx2 = (caminhoTx2, dadosNota, dadosEmitente, itens, pagamentos, totalizadores, tecnico, cnpjAutorizado, cpfAutorizado, observacoes) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        if (fs.existsSync(caminhoTx2)) {
            ...
            yield createObservacoes(caminhoTx2, observacoes);
            yield closeFile(caminhoTx2);
            resolve(caminhoTx2);
        }
    }));
};
 ...
 * @return retorna uma string do caminho onde o arquivo foi gerado
 */
const generateNFeTx2 = (caminhoTx2, dadosNota, dadosEmitente, dadosDestinatario, itens, pagamentos, totalizadores, tecnico, cnpjAutorizado, cpfAutorizado, observacoes) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        if (fs.existsSync(caminhoTx2)) {
            reject('Já existe um tx2 no caminho especificado.');
        }
