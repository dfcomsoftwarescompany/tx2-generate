 ...
 */
const sendNFCe = (tx2Path, cnpj, grupo, authorization, port) => {
    return new Promise((resolve, reject) => {
        const form = {
            CNPJ: cnpj,
            Grupo: grupo,
 ...
 * @param authorization a string de autorização para acessar a api da tecnospeed.
 */
const sendNFe = (tx2Path, cnpj, grupo, authorization, port) => {
    return new Promise((resolve, reject) => {
        const form = {
            CNPJ: cnpj,
            Grupo: grupo,
 ...
 */
const print = (authorization, key, url, group, cnpj, port) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        const form = {
            ChaveNota: key,
            CNPJ: cnpj,
 ...
 * @returns
 */
const cancelNFCe = (authorization, group, cnpj, nfceKey, justify, port) => {
    return new Promise((resolve, reject) => {
        try {
            const form = {
                ChaveNota: nfceKey,
